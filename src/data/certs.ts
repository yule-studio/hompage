...
export const certs: Cert[] = [
  ...
  { name: "AWS Solutions Architect — Associate",     issuer: "AWS", year: 2026, status: "in-progress", id: "AWS-SAA-C03" },
  ...
  { name: "AWS Solutions Architect — Associate",     issuer: "AWS", year: 2024, status: "expired", id: "AWS-SAA-C03" },
