...
export const activities: Activity[] = [
  ...
  { at: 20230427, period: "2023.04.27", title: "지역인재 합동 채용 설명회" },
  {
    ...
    detail: {
      ...
      facts: [
        { label: "형태", value: "학교 MOU 기업 현장실습" },
        { label: "기간", value: "2023.11 – 2024.01 (3개월)" },
        { label: "소속", value: "SW 2팀 · V2X AIR" },
        { label: "분야", value: "5G 기반 V2X 통신" },
      ],
      summary:
        "학교가 MOU를 맺은 기업에서 ==3개월간 현장실습==을 했다. 5G 기반 ==V2X 통신== " +
        "솔루션을 만드는 회사의 ==SW 2팀==에 소속되어, 기술 자체보다도 실무에서 일이 " +
        "어떻게 굴러가는지를 가까이에서 봤다.",
      hero: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "SW 2팀에서 맡은 업무가 이 제품과 관련된 일이었다. 차량에 실린 단말이 주변에서 " +
              "오는 V2X 메시지를 받고, 그 정보를 블루투스로 스마트폰에 넘겨 운전자가 실제로 " +
              "볼 수 있는 형태로 만든다.",
            "여기서 앞서 공부한 것들이 한 줄로 이어졌다. 단말과 앱 사이의 연결, 서버와 " +
              "주고받는 데이터, 그리고 그 안에 담기는 V2X 메시지가 각각 소켓 · 비동기 통신 · " +
              "V2X 용어라는 이름으로 정리해둔 것들이었다.",
          ],
        },
        {
          heading: "SW 2팀에서 맡은 일",
          body: [
            "SW 2팀에 소속되어 V2X AIR 와 관련된 업무를 맡았다. V2X 기술이 문서 속 개념이 " +
              "아니라 실제로 어떻게 구현되고 쓰이는지를 볼 수 있었던 자리였다.",
            "처음에는 기대만큼 걱정도 컸다. 경험이 부족한 상태로 실무에 적응할 수 있을지, " +
              "회사에서 몫을 할 수 있을지 하는 고민이었다. 팀원분들과 멘토님이 적극적으로 " +
              "도와주신 덕분에 생각보다 빠르게 적응했고, 배우는 과정 자체를 즐길 수 있었다.",
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            ...
            "구성요소는 차량에 실리는 OBU, 도로변에 서는 RSU, 보행자처럼 보호가 필요한 " +
              "VRU 로 나뉜다. 메시지에는 차량 상태를 알리는 BSM, 보행자를 알리는 PSM, " +
              "신호 정보를 담는 SPAT 같은 것들이 있다. 이 표를 만들고 팀 앞에서 발표했다.",
          ],
        },
        {
          heading: "실습에서 배운 두 가지",
          body: [
            "**소통** — 모르는 것을 혼자 붙잡고 있기보다 즉시 묻고 피드백을 받는 편이 훨씬 " +
              "빠르다는 걸 몸으로 배웠다. 정확하고 빠른 커뮤니케이션이 곧 업무 효율이었다.",
            "**문서** — 회사에는 정해진 문서 형식과 규칙이 있고, 그걸 지키는 것이 중요했다. " +
              "처음에는 생소했지만 피드백을 받으며 맞춰갔다. 위 세 편은 그렇게 쓴 기록이고, " +
              "V2X 용어는 교육 자료로 만들어 직접 발표까지 했다.",
          ],
        },
        {
          heading: "3개월 뒤",
          body: [
            "12월 31일자로 실습이 끝났다. 회사 사정으로 취업 연계까지는 이어지지 않아 다시 " +
              "광주로 돌아왔다.",
            "당시에는 아쉬움이 컸지만, 시간이 지나며 이 경험을 성장의 재료로 쓰기로 했다. " +
              "3개월 동안 V2X 기술과 개발 환경을 익혔고, 협업과 소통이 실무에서 어떤 " +
              "무게를 갖는지 알게 됐다. 지금도 V2X · 자율주행 · 5G 분야는 계속 관심을 두고 " +
              "보고 있다.",
          ],
        },
      ],
  ...
  { at: 20240923, period: "2024.09.23", title: "LG 유플러스 테크 컨퍼런스" },
  {
    ...
    highlight: true,
    detail: {
      org: "원티드 · 프리온보딩 BE 챌린지 11월",
      facts: [
        { label: "형태", value: "프리온보딩 백엔드 챌린지" },
        { label: "기간", value: "2024.11.05 – 2024.11.14 (10일)" },
        { label: "주제", value: "PG 통합 결제 모듈 클론 코딩" },
        { label: "사전 과제", value: "클래스 다이어그램 · 아키텍처 · ERD" },
      ],
      summary:
        "여러 PG사의 결제 API를 ==하나의 API로 통합==하는 결제 모듈을 클론 코딩하는 " +
        "챌린지였다. 목표는 기능을 똑같이 만드는 것이 아니라, 배운 ==OOP와 SOLID를 " +
        "설계와 구현에 실제로 녹여내는 것==이었다.",
      sections: [
        {
          heading: "참여한 이유",
          body: [
            "백엔드 개발자로 성장하는 과정에서 새로운 기술을 계속 찾아 헤매기보다, " +
              "기본기를 탄탄히 하고 거기서 넓혀가는 편이 더 가치 있다고 생각했다. " +
              "객체지향 같은 핵심 원리를 제대로 이해하고 쓰는 것이 길게 보면 더 도움이 " +
              "될 것이라 믿었다.",
            "그 고민과 이 챌린지의 방향이 정확히 맞았다. 기본기를 한 번 더 단단히 하려고 " +
              "참여했다.",
          ],
        },
        {
          heading: "요구사항 — 확장 가능성과 공통화",
          body: [
            "고객의 요구는 한 줄이었다. 다수 PG사의 결제 서비스를 하나의 API로 통합해서 " +
              "쓸 수 있게 해달라는 것. 문제는 그 아래 깔린 두 가지 비즈니스 요구였다.",
            "**하나, 지금은 PG사가 하나지만 곧 늘어난다.** 어떤 PG사를 붙일지는 자유지만 " +
              "설계는 확장 가능성을 전제로 해야 했다.",
            "**둘, PG사마다 요청·응답 메시지 형식이 다르다.** RequestDTO 를 어떤 구조로 " +
              "두어야 각 PG사에 맞게 효율적으로 변환되는지, 제각각인 응답을 어떤 구조로 " +
              "공통화할지가 과제의 핵심이었다.",
          ],
        },
        {
          heading: "설계 — 어떤 패턴을 왜 골랐나",
          body: [
            "요구사항을 읽자마자 든 생각은 '디자인 패턴을 써야겠다'였다. 요구가 곧 " +
              "패턴의 정의와 겹쳤기 때문이다.",
            "아키텍처는 클라이언트 → API Gateway → 결제 시스템으로 이어지는 기본 흐름을 " +
              "먼저 잡고, 그 뒤에 각 PG사와의 통신을 어디서 어떻게 흡수할지를 붙여나가는 " +
              "순서로 접근했다.",
          ],
          list: [
            "Factory Pattern — PG사 객체 생성 로직을 한 곳에서 관리해 확장성을 확보",
            "Adapter Pattern — PG사마다 다른 요청·응답 형식을 하나로 통일",
            "Strategy Pattern — 결제 처리 전략을 분리",
          ],
        },
        {
          heading: "처음 그려본 클래스 다이어그램",
          body: [
            "부트캠프에서 아키텍처 구조와 ERD 는 여러 번 그려보며 고쳐왔지만, 클래스 " +
              "다이어그램과 시퀀스 다이어그램은 한 번도 그려본 적이 없었다. 그래서 " +
              "설계에 들어가기 전에 그게 무엇인지부터 정리했다.",
            "클래스 다이어그램은 클래스의 구성요소와 클래스 간 관계를 나타내는 정적 " +
              "다이어그램이다. 쓸모는 그림 자체가 아니라 의존 관계를 눈에 보이게 만드는 " +
              "데 있다. 순환 의존이 어디서 생기는지 찾아내고, 그 고리를 어디서 끊을지 " +
              "정할 수 있게 해준다.",
            "관계를 하나씩 코드로 옮겨보면서 개념이 붙었다. 특히 Aggregation 과 " +
              "Composition 의 차이가 그랬다. 참조하는 클래스의 라이프 사이클이 종속적인가 " +
              "아닌가 — 밖에서 가져온 객체는 이쪽이 죽어도 다른 곳에서 참조할 수 있지만, " +
              "안에서 생성한 객체는 같이 사라진다.",
          ],
        },
        {
          heading: "주차별 학습",
          body: [
            "수업은 네 개의 주제로 나뉘어 있었다. 각 수업마다 문제 형식의 답변을 " +
              "요구했는데, 그 과정에서 내가 어디를 모르는지가 드러났다.",
          ],
          list: [
            "효율적이면서 현대스러운 코드 작성 방법",
            "Deep dive — Spring 의 기능 자세히 살펴보기",
            "객체지향스러운 아키텍처를 설계해보기",
            "전역변수를 설정하는 기준과 방법",
          ],
        },
        {
          heading: "챌린지가 남긴 것",
          body: [
            "그때까지 참여한 챌린지 중 가장 값진 경험이었다. 의문문으로만 남아 있던 " +
              "생각들을 명확히 정리할 수 있었고, 써보지 않은 방법들을 배워 프로젝트에 " +
              "도입해보고 싶은 아이디어도 얻었다.",
            "무엇보다 자바와 스프링을 앞으로 어떤 방향으로 활용해야 할지, 그 길이 " +
              "이전보다 선명해졌다.",
          ],
        },
      ],
      ...
      links: [
        {
          label: "OOP와 SOLID를 이용한 클론코딩 — 챌린지 정리",
          url: "https://yuchan-log.notion.site/134e393caf8a80bd9bdbdb3628a91e32",
          note: "사전 과제 설계부터 주차별 학습 자료, 소감까지 모아둔 문서.",
        },
      ],
    },
  },
  {
    ...
    highlight: true,
    detail: {
      org: "Back 투더 퓨처 · 자율 스터디",
      facts: [
        { label: "형태", value: "Java · Spring 역량 강화 스터디" },
        { label: "기간", value: "2024.11.11 – 2025.10.01 (약 11개월)" },
        { label: "교재", value: "자바의 정석 (남궁성)" },
        { label: "방식", value: "각자 정독 → 알게 된 점 공유 → 질문 정리" },
      ],
      summary:
        "==Java와 Spring 역량을 기르기 위한 스터디==다. 2024년 11월에 시작해 약 11개월 " +
        "이어졌다. 새 기술을 좇기보다 ==기초부터 차근차근==이라는 마음으로 『자바의 " +
        "정석』을 함께 정독하고, 각자 알게 된 것과 몰랐던 것을 모아 기록으로 남겼다.",
      sections: [
        {
          heading: "왜 책부터였나",
          body: [
            "유레카 과정을 지나며 자바는 확실히 익숙해졌지만, 익숙한 것과 아는 것은 " +
              "다르다. 스터디를 시작하면서 기초부터 차근차근 하자는 마음으로 『자바의 " +
              "정석』을 골랐다.",
            "책도 강의도 훌륭하지만, 원하는 부분을 다시 찾으려면 매번 목차부터 뒤져야 " +
              "하는 불편이 있었다. 그래서 읽으면서 중요하다고 생각한 개념과 활용 방법을 " +
              "따로 정리했다. 남의 책을 요약한 게 아니라 내 방식으로 다시 배열한, " +
              "말하자면 나만의 자바의 정석이다.",
          ],
        },
        {
          heading: "범위를 정한 것도 설계였다",
          body: [
            "전부 다시 읽지는 않았다. 변수 · 연산자 · 조건문 · 반복문처럼 이미 문제없이 " +
              "쓰고 있는 부분은 건너뛰었고, 네트워킹은 따로 다룰 주제라 제외했다.",
            "이미 할 수 있는 것과 모르는 것을 먼저 갈라두면, 남은 시간을 모르는 쪽에만 " +
              "쓸 수 있다. 이 판단이 11개월을 버티게 한 이유이기도 하다.",
          ],
        },
        {
          heading: "진행 방식 — 읽고, 나누고, 남긴다",
          body: [
            "각자 책을 정독하고 모여서 알게 된 점과 몰랐던 점을 공유했다. 이미 알던 " +
              "내용이라도 남에게 설명하려고 하면 다시 걸리는 부분이 나온다. 그 걸리는 " +
              "지점을 그냥 넘기지 않고 질문으로 정리해 기록에 남겼다.",
            "쌓인 질문들은 대부분 '안다고 생각했지만 설명은 못 하던' 것들이었다.",
          ],
          list: [
            "클래스 초기화와 인스턴스 초기화는 언제, 어떤 순서로 일어나는가",
            "변수 초기화 순서",
            "오버로딩과 메서드 오버라이딩의 경계",
            "static 메서드는 어떤 기준으로 정의하는가",
            "Lombok 은 어디까지 써도 되는가",
          ],
        },
        {
          heading: "11개월이 남긴 것",
          body: [
            "혼자 읽었다면 아는 부분은 빠르게 넘기고 모르는 부분은 어물쩍 지나갔을 " +
              "책이다. 같이 읽으니 그게 안 됐다. 넘어가려던 자리마다 누군가의 질문이 " +
              "걸렸고, 그 질문들이 그대로 기록이 됐다.",
            "이 스터디에서 자바를 다시 잡아둔 덕분에, 이후 Spring 을 파고들 때 " +
              "'프레임워크가 해주는 것'과 '언어가 해주는 것'을 갈라 볼 수 있게 됐다.",
          ],
        },
      ],
      linksHeading: "노션 링크",
      links: [
        {
          label: "[자바의 정석] — 나만의 정리",
          url: "https://yuchan-log.notion.site/7d1d783fb72c4d57a62776fc77d85df7",
          note: "책을 읽으며 중요한 개념과 활용 방법을 다시 배열해 정리한 일지.",
        },
        {
          label: "스터디 진행 과정 중 나온 질문 정리",
          url: "https://yuchan-log.notion.site/144e393caf8a803ab0b4db4a405496b9",
          note: "서로 정독하며 나온 질문들을 모아둔 기록.",
        },
      ],
    },
  },
